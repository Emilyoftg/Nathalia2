...
BOT_TOKEN = environ.get('BOT_TOKEN', "5702230511:AAGHA7trjv0lfwjEOApeoQQiXg5HbXkKb-8")
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://myre:myre@cluster0.xdwxd.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001799535693'))
...
MELCOW_NEW_USERS = is_enabled((environ.get('MELCOW_NEW_USERS', "Fallse")), True)
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', 'b9b472e4634a61b4b313b7ed041d76fd348ba2d3')
...
CAPTION_BUTTON = "‼️ 𝖴𝖯𝖣𝖠𝖳𝖤𝖲 𝖢𝖧𝖠𝖭𝖭𝖤𝖫 ‼️"
CAPTION_BUTTON_URL = "https://t.me/MCMovieBot"
